...
Source0:   https://github.com/gganis/vomsxrd/archive/v%{version}/vomsxrd-%{version}.tar.gz
Patch0:    0001-Free-X509-structures.patch
...
#-------------------------------------------------------------------------------
%changelog
* Fri Mar 03 2017 John Thiltges <jthiltges2@unl.edu> - 1:0.4.0-2.20170303.2
- Include patch to free X509 structures
...
* Thu Mar 21 2013 G. Ganis <gerardo.ganis@cern.ch>
- Created
