...
%define hadoop_release 1.cdh5.12.1.p0.3.%{osg_patchlevel}.20210319.1%{?dist} 
...
Patch16: hdfs-client-tcp-keepalive.patch
...
%changelog
* Fri Mar 19 2021 John Thiltges <jthiltges@unl.edu> - 2.6.0+cdh5.12.1+2540-1.cdh5.12.1.p0.3.8.20210319.1
- Add patch to enable SO_KEEPALIVE on HDFS client TCP connections
