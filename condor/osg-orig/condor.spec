...
%changelog
* Tue Sep  3 2013 <bbockelm@cse.unl.edu> - 8.1.2-0.1.4303024.git
- Sync with latest master; rebuild to OSG Koji.

* Sun Aug 18 2013 <bbockelm@cse.unl.edu> - 8.1.1-0.2.df32f21.git
- Update to avoid expand_macro bug.

* Mon Aug  5 2013 <bbockelm@cse.unl.edu> - 8.1.1-0.1.3966cc1.git
- Update to 8.1.1 pre-release.
- Fix pyclassad issues (#3780).

* Thu Jun 20 2013 <bbockelm@cse.unl.edu> - 8.1.0-0.2.24ea734.git
- Rebuild for gangliad improvements.
