...
# Generated with:
# git archive --prefix=htcondor-ce-%{gitdate}/ %{gitrev} | xz -9 > %{name}-%{gitdate}.tar.xz
...
%changelog
* Mon May 15 2017 John Thiltges <jthiltges@unl.edu> - 2.1.5-1.20170515git62f4ca3d
- Build of master including support for WholeNodeWanted flag
